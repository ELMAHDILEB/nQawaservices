...
if (!isset($_SESSION['type']) || $_SESSION['type'] !== 'admin') {
    ...
    $query = "SELECT * FROM workers LIMIT $start_from, $num_per_page";
    $result = mysqli_query($conn, $query);

    $total_records_query = "SELECT COUNT(*) AS total FROM workers";
...
?>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="action">
                <!-- <a href="index.php?page=add__user" class="add">Add User</a> -->
            </div>
            <div class="table">
                <table id="showdataTeam">
                    <thead>
                        <tr>
                            <th>Type</th>
                            <th>Username</th>
...
<td class='action'>
                                    <a class='edit' href='edit__user.php?id=<?= $row['idWorker']; ?>'><i class="fas fa-edit"></i></a>
                                    <a class='delete' href='delete__user.php?id=<?= $row['idWorker']; ?>'><i class="fa-solid fa-trash-can"></i></a>
                                </td>
            ...
            <div class="pagination">
                <?php if ($page > 1) {
                    echo "<a href='index.php?page=team&page_number=" . ($page - 1) . "' class='arrowLeft'><i class='fa-solid fa-chevron-left'></i></a>";
                } ?>
                ...
                for ($i = 1; $i < $total_pages; $i++) {
                    echo '<a href="index.php?page=team&page_number=' . $i . '" class="numPages">' . $i . '</a>';
                }
                ?>

                <?php if ($page < $total_pages) {
                    echo "<a href='index.php?page=team&page_number=" . ($page + 1) . "' class='arrowRight'><i class='fa-solid fa-chevron-right'></i></a>";
                } ?>
