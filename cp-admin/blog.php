    ...
    <div class="container">
        ...
        <div class="table">
            ...
            ./picBlog/<?= $row['image'] ?> 563w,
                ...
                " src="./picBlog/<?= $row['image'] ?>" alt="slider3" loading="lazy" decoding="async" />
                                        <div>
                                </td>
                                <td>
                                ...
                                <td><?= $row['DateAdd'] ?></td>
                                <td class='action'>
                                    <a class='edit' href='edit__blog.php?id=<?= $row['id_blogs']; ?>'><i class="fas fa-edit"></i></a>
                                    <a class='delete' href='delete__blog.php?id=<?= $row['id_blogs']; ?>'><i class="fa-solid fa-trash-can"></i></a>
                                </td>
                            </tr>
                            <tr>
                        <?php
