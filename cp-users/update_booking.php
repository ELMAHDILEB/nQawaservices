...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    if (isset($_POST["submit"])) {
        ...
        if ($insertSQL) {
            $sql = "UPDATE booking SET `service` = '$service', typeOfService = '$typeOfService',`numberPhone` = '$numberPhone', `address` = '$address', `date` = '$date', `time` = '$time' WHERE `id_booking` = '$id_booking'";
